...
//    private final static String DB_PWD="123456";
    ...
    private final static String DB_URL="jdbc:oracle:thin:@10.18.103.38/ORCLDEV";
    ...
    private final static String PACKAGE_PARENT="com.taiyangguo.mybatisgenerator";
    private final static String OUT_PUT_DIR = "/src/main/java";
    private final static String RESOURCES_DIR = "/src/main/resources/mapper/";
