...
//    private final static String DB_PWD="hbzyyapp123456";
    ...
    private final static String OUT_PUT_DIR = "/elasticsearch-server/src/main/java";
    private final static String PACKAGE_PARENT="com.sinosoft.elasticsearch";
    private final static String RESOURCES_DIR = "/elasticsearch-server/src/main/resources/mapper/";
