...
public class JobLogAspect {
    @Pointcut("execution(public * com.sinosoft.elasticjob.*.service.job..*.*(..))")
    ...
    @AfterReturning(value="JobPointcut()",returning="result")
    ...
    @AfterThrowing(value="JobPointcut()",throwing="e")
